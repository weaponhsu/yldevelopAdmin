      ...
      this.$refs.loginForm.validate(valid => {
        if (valid) {
          ...
          this.$store.dispatch('user/login', this.loginForm).then(() => {
            if (this.$store.state.user.google_authenticator === true) {
              if (this.redirect) {
                this.$router.push({ path: '/googleAuthenticator', query: { redirect: this.redirect } })
              } else {
                this.$router.push({ path: '/googleAuthenticator' })
              }
            } else {
